/*
  ...
  Compiled with Arduino 1.8.13, and esp32-arduino core version 1.06, on Dec 25, 2021.
...
"C:\\ArduinoPortable\\arduino-1.8.13\\portable\\packages\\esp32\\tools\\xtensa-esp32-elf-gcc\\1.22.0-97-gc752ad5-5.2.0/bin/xtensa-esp32-elf-size" -A "C:\\Users\\James\\AppData\\Local\\Temp\\arduino_build_382359/ESP32-CAM-Video-Recorder-junior-57.ino.elf"
Sketch uses 1145526 bytes (36%) of program storage space. Maximum is 3145728 bytes.
Global variables use 59924 bytes (18%) of dynamic memory, leaving 267756 bytes for local variables. Maximum is 327680 bytes.
...
const int avi_header[AVIOFFSET] PROGMEM = {
  ...
  0x76, 0x35, 0x37, 0x20, 0x4C, 0x49, 0x53, 0x54, 0x00, 0x01, 0x0E, 0x00, 0x6D, 0x6F, 0x76, 0x69,
};
...
<h1>%s<br>ESP32-CAM Video Recorder Junior %s <br><font color="red">%s</font></h1><br>
 ...
 <h3><a href="http://%s:%d">File Manager - download, delete, edit </a></h3>
  ...
  sprintf(the_page, msg, devname, devname, vernum, strdate, use, tot, rssi, avi_file_name,
          ...
          localip, localip, localip, localip, localip, filemanagerport );
