/*
  ...
  *****
  *
  * Sep 15 Quick mod to write a mjpeg file rather than an avi.
  * - no headers, no index, no sense of interframe time
  * - just plays on computer as fast as it cam
  * 
  * 
  *
  ****
...
static esp_err_t start_avi() {
  ...
  Serial.println("Starting an mjpeg ");

  sprintf(fname, "/sdcard/%s %d.%d + %ds.mjpeg",  devname, file_group, file_number, (millis()-boot_time)/1000);
