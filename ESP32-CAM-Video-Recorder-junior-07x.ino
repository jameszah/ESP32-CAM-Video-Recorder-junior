...
int avi_length = 300;               // how long a movie in seconds -- 300 = 5 minutes
...
static esp_err_t another_save_avi(camera_fb_t * fb ) {
  ...
  framebuffer_static[0] = 0x63;
  framebuffer_static[1] = 0x64;
  framebuffer_static[2] = 0x30;
  framebuffer_static[3] = 0x30;
  framebuffer_static[4] = jpeg_size % 0x100;
  framebuffer_static[5] = (jpeg_size >> 8) % 0x100;
  framebuffer_static[6] = (jpeg_size >> 16) % 0x100;
  framebuffer_static[7] = (jpeg_size >> 24) % 0x100;
